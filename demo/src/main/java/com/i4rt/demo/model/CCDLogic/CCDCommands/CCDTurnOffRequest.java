...
@NoArgsConstructor
public class CCDTurnOffRequest implements CCDCommand {
    ...
    public static String sendData() {
        ...
        String dataStr = "123401" + "55".repeat(1024 - 3);
        ...
        return "<div class = \"row\" style = \"width: fit-content; align-items: baseline\"><b style=\"color: red; font-weight: bold\">ERROR</b>: Не удалось выключить КПА<br></div>";
    }
}
